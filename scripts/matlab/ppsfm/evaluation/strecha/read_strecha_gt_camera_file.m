function strecha_gt_camera = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   STRECHA_GT_CAMERA = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   STRECHA_GT_CAMERA = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   strecha_gt_camera = importfile('0000.png.camera', 1, 9);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/03/02 15:34:06
...
strecha_gt_camera = [dataArray{1:end-1}];
